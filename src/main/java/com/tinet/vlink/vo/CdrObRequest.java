...
public class CdrObRequest {
	...
	public void setRequestUniqueId(String requestUniqueId) {
		this.requestUniqueId = requestUniqueId == null ? null : requestUniqueId
				.trim();
	}
	...
	public void setCustomerNumber(String customerNumber) {
		this.customerNumber = customerNumber == null ? null : customerNumber
				.trim();
	}
	...
	public void setCustomerAreaCode(String customerAreaCode) {
		this.customerAreaCode = customerAreaCode == null ? null
				: customerAreaCode.trim();
	}
	...
	public void setCustomerProvince(String customerProvince) {
		this.customerProvince = customerProvince == null ? null
				: customerProvince.trim();
	}
	...
	public void setCalleeAreaCode(String calleeAreaCode) {
		this.calleeAreaCode = calleeAreaCode == null ? null : calleeAreaCode
				.trim();
	}
	...
	public String toString() {
		return "CdrOb5000017 [id=" + id + ", uniqueId=" + uniqueId
				+ ", requestUniqueId=" + requestUniqueId + ", clid=" + clid
				...
				+ ", calleeAreaCode=" + calleeAreaCode + ", requestTime="
				+ requestTime + ", startTime=" + startTime + ", answerTime="
				+ answerTime + ", dialTime=" + dialTime + ", bridgeTime="
				+ bridgeTime + ", endTime=" + endTime + ", monitorStartTime="
				+ monitorStartTime + ", monitorEndTime=" + monitorEndTime
				+ ", monitorDuration=" + monitorDuration + ", billDuration="
				+ billDuration + ", bridgeDuration=" + bridgeDuration
				+ ", totalDuration=" + totalDuration + ", ivrId=" + ivrId
				+ ", ivrName=" + ivrName + ", ivrFlow=" + ivrFlow
				+ ", telsetName=" + telsetName + ", recordFile=" + recordFile
				+ ", callType=" + callType + ", status=" + status + ", mark="
				+ mark + ", markData=" + markData + ", endReason=" + endReason
				+ ", gwIp=" + gwIp + ", userField=" + userField + ", sipCause="
				+ sipCause + ", createTime=" + createTime + "]";
	}
