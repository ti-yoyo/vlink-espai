...
public class CdrOb {
    ...
    //private List<CdrObDetail> details = new ArrayList<CdrObDetail>();
    ...
    public void setRequestUniqueId(String requestUniqueId) {
        this.requestUniqueId = requestUniqueId == null ? null : requestUniqueId.trim();
    }
	...
	public String toString() {
		return "CdrOb [id=" + id + ", uniqueId=" + uniqueId
				+ ", requestUniqueId=" + requestUniqueId + ", clid=" + clid
				+ ", detailClid=" + detailClid + ", customerNumber="
				+ customerNumber + ", customerNumberType=" + customerNumberType
				...
				+ sipCause + ", createTime=" + createTime + ", enterpriseId="
