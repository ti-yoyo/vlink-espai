...
public class DateUtil {
	 ...
	 */
	public static int getTimeStemp(String strdate) {
	...
	public static int getTimeStemp(String strdate,String datePattern) {
	...
	public static String getDayInMonth(Date anyDayOfMonth, boolean flag) {
		...
		if (flag) {
			...
			try {
				Date firstDayOfNextMonth = convertStringToDate(format(
						cal.getTime(), "yyyy-MM")
						+ "-01");
	...
	public static void main(String[] args) {
		int stemp=DateUtil.getTimeStemp("2016-5-31");
		System.out.println(stemp);
		
		String s=DateUtil.format("1466439131", DateUtil.FMT_DATE_YYYY_MM_DD_HH_mm_ss);
		String e=DateUtil.format("1466439132", DateUtil.FMT_DATE_YYYY_MM_DD_HH_mm_ss);
